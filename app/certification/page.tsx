    ...
    <main className="bg-white pb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden h-full flex flex-col">
              ...
              <div className="px-6 pb-6">
                <Link href="/apply-certification?level=professional">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden h-full flex flex-col">
              ...
              <div className="px-6 pb-6">
                <Link href="/apply-certification?level=expert">
                  <Button className="w-full">Apply Now</Button>
                </Link>
              </div>
            </div>
      ...
      <section className="py-12 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Join the elite group of certified RTLS professionals</p>
          <Link href="/contact">
            <Button className="bg-white text-blue-700 hover:bg-blue-50">Contact Us to Begin</Button>
          </Link>
        </div>
      </section>
    </main>
