...
export const metadata: Metadata = {
  title: "RTLS + Digital Twin Integration - RTLS Alliance",
  description:
    "Discover how real-time location systems power next-generation digital twin platforms for enhanced visibility and control.",
  keywords:
    "RTLS, digital twin, integration, real-time location, IoT, positioning technologies, indoor positioning, location tracking",
  openGraph: {
    title: "RTLS + Digital Twin Integration - RTLS Alliance",
    description:
      "Discover how real-time location systems power next-generation digital twin platforms for enhanced visibility and control.",
    url: "https://rtlsalliance.com/rtls-digital-twin",
    siteName: "RTLS Alliance",
    images: [
      {
        url: "https://rtlsalliance.com/images/rtls-architecture.png",
        width: 1200,
        height: 630,
        alt: "RTLS Digital Twin Integration",
      },
    ],
    locale: "en_US",
    type: "article",
  ...
  twitter: {
    ...
    description:
      "Discover how real-time location systems power next-generation digital twin platforms for enhanced visibility and control.",
    images: ["https://rtlsalliance.com/images/rtls-architecture.png"],
  },
  alternates: {
    canonical: "https://rtlsalliance.com/rtls-digital-twin",
  },
}

export default function RTLSDigitalTwinPageWrapper() {
  ...
  return (
    <>
      <PageSEO
        ...
        imageUrl="https://rtlsalliance.com/images/rtls-architecture.png"
        type="article"
      />
        ...
        <section className="py-12 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Discover how real-time location systems power next-generation digital twin platforms for enhanced
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-700">
                  Create and manage location-based business rules and automated workflows.
                </p>
              </Link>
