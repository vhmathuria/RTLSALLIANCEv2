...
export default function AuthForm({ defaultTab = "login", redirectTo = "/", error }: AuthFormProps) {
  ...
  const handleSocialLogin = async (provider: "google" | "linkedin") => {
    ...
    try {
      ...
      setFormError(err.message || `An error occurred during ${provider} login`)
    } finally {
      setLoading(false)
    }
  }
          ...
          <CardContent>
            {(error || formError) && (
              <div className="bg-red-100 text-red-800 p-3 rounded-md mb-4">
                ...
                {error === "missing_code" && "Authentication code is missing."}
                {formError && formError}
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button
                ...
                className="flex items-center justify-center"
              >
                <Image src="/linkedin-logo.png" alt="LinkedIn" width={20} height={20} className="mr-2" />
                LinkedIn
              </Button>
            </div>
          </CardContent>
