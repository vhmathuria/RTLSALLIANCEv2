...
interface MemberInsightExpertPerspectiveProps {
  quote: string
  author: string
  role: string
  company: string
...
export default function MemberInsightExpertPerspective({
  quote,
  author,
  role,
  company,
  image,
}: MemberInsightExpertPerspectiveProps) {
  ...
  return (
    <section className="my-12">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-1 shadow-lg">
        <div className="bg-white rounded-md p-6 md:p-8">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className={image ? "md:w-3/4" : "w-full"}>
              <svg className="h-10 w-10 text-indigo-600 mb-4 opacity-50" fill="currentColor" viewBox="0 0 32 32">
