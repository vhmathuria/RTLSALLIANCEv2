...
interface TechnologyComparisonCitationsProps {
  citations: Citation[] | null | undefined
}

export default function TechnologyComparisonCitations({ citations }: TechnologyComparisonCitationsProps) {
  // Check if citations is an array and has items
