...
export default function SuccessStoryTestimonial({
  ...
  return (
    <section className="my-12 w-full">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-1 shadow-md">
        <div className="bg-white rounded-md p-6 md:p-8">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className={image ? "md:w-3/4" : "w-full"}>
              <svg className="h-10 w-10 text-blue-600 mb-4 opacity-50" fill="currentColor" viewBox="0 0 32 32">
