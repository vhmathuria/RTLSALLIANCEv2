...
interface GuideSidebarProps {
  ...
  author: string
  readingTime?: number
  sectionIds?: string[] // Add section IDs prop
}

export default function GuideSidebar({ toc, title, publishDate, author, readingTime, sectionIds }: GuideSidebarProps) {
          ...
          {toc.map((item, index) => (
            <li key={index}>
              ...
              >
                ...
                <span>{index === 1 ? "Who Should Read This Guide" : item}</span>
              </button>
            </li>
          ))}
        </ul>
